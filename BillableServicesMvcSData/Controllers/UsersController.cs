...
{
    public class UsersController : DefaultController<vwsUser>
    {
        public UsersController() : base(new BillableServiceRepository<vwsUser>()) { }

        // GET api/product/5
        [HttpGet]
        [ActionName(SDataRoutesUtil.SDATA_ACTION_SINGLE)]
        public override vwsUser GetSingle(int selector, String select, string include)
        {
